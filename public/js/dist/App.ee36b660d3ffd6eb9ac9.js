...
function Chatbot() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    to: "/ikea"
  }, "Take me to IKEA")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
    to: "/shop"
  }, "Take me to the Shop")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
    to: "/checkout"
  }, "Take me to Checkout")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
    to: "/guestSignUp"
  }, "I want to sign in")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
    to: "/cart"
    ...
    to: "/AboutUs"
  }, "Learn About Us")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
    to: "/orders"
...
function UserPortal(_ref) {
  ...
  }, user.isLoggedIn || !user.username === 'guestuser' ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/account"
...
/* harmony import */ var _utilities_users_services__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../utilities/users-services */ "./src/utilities/users-services.js");
/* harmony import */ var _utilities_order_api__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../utilities/order-api */ "./src/utilities/order-api.js");
...
/* harmony import */ var _stripe_react_stripe_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @stripe/react-stripe-js */ "./node_modules/@stripe/react-stripe-js/dist/react-stripe.umd.js");
...
/* harmony import */ var _stripe_stripe_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @stripe/stripe-js */ "./node_modules/@stripe/stripe-js/dist/stripe.esm.js");
/* harmony import */ var _components_ChatBot_ChatBot__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../components/ChatBot/ChatBot */ "./src/components/ChatBot/ChatBot.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
const stripePromise = (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_15__.loadStripe)("pk_test_51NpKNzCxDlNhNZhrOOhIAHeCTWCsyYL624QdJtDaY1APXwBgASPjpnvqQQnRYto4MwzFecsHgRcrPPGNpdN0APay00Ck9gDdW9");

function App() {
  const [pexelsData, setPexelsData] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [user, setUser] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((0,_utilities_users_services__WEBPACK_IMPORTED_MODULE_17__.getUser)());
  ...
  function _createGuestUser() {
    _createGuestUser = _asyncToGenerator(function* () {
      ...
      const guestUser = yield (0,_utilities_users_services__WEBPACK_IMPORTED_MODULE_17__.signUp)(guestUserData);
      setUser(guestUser);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    function _getCartItems() {
      _getCartItems = _asyncToGenerator(function* () {
        const cart = yield _utilities_order_api__WEBPACK_IMPORTED_MODULE_18__.getCart();
        setCart(cart);
      });
      return _getCartItems.apply(this, arguments);
    }
  ...
  function _handleChangeQty() {
    _handleChangeQty = _asyncToGenerator(function* (itemId, newQty) {
      const updatedCart = yield _utilities_order_api__WEBPACK_IMPORTED_MODULE_18__.setItemQtyInCart(itemId, newQty);
      setCart(updatedCart);
    });
    return _handleChangeQty.apply(this, arguments);
  }
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_stripe_react_stripe_js__WEBPACK_IMPORTED_MODULE_14__.Elements, {
    stripe: stripePromise
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
    className: _App_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].App
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_NavBar_NavBar__WEBPACK_IMPORTED_MODULE_7__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_UserPortal_UserPortal__WEBPACK_IMPORTED_MODULE_6__["default"], {
    user: user,
    setUser: setUser,
    setCart: setCart,
    cart: cart,
  ...
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ChatBot_ChatBot__WEBPACK_IMPORTED_MODULE_16__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Footer_Footer__WEBPACK_IMPORTED_MODULE_5__["default"], null)));
}
...
/* harmony import */ var _components_MenuListItem_MenuListItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/MenuListItem/MenuListItem */ "./src/components/MenuListItem/MenuListItem.js");
/* provided dependency */ var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
function FavoritesPage(_ref) {
  ...
  const [activeFavorites, setActiveFavorites] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    function _fetchFavoriteItems() {
      _fetchFavoriteItems = _asyncToGenerator(function* () {
        const favorites = yield FavoriteItem.getFavoriteItems();
  ...
  }, /*#__PURE__*/React.createElement("aside", null, /*#__PURE__*/React.createElement(NavBar, null), /*#__PURE__*/React.createElement(_components_Logo_Logo__WEBPACK_IMPORTED_MODULE_1__["default"], null), /*#__PURE__*/React.createElement(Footer, null), /*#__PURE__*/React.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/items/favorites"
  }, "Favorites"), /*#__PURE__*/React.createElement(UserLogOut, {
    user: user,
    setUser: setUser
  })));
}
...
.mq7oEaSkRoDV3bNXSeeL li a:hover {
  color: blue;
}`, "",{"version":3,"sources":["webpack://./src/components/NavBar/NavBar.module.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,mBAAA;AACJ;AACE;EACI,gBAAA;EACA,UAAA;EACA,aAAA;AACN;AAEE;EACI,cAAA;EACA,aAAA;EACA,qBAAA;AAAN;AAGE;EACI,aAAA;EACA,YAAA;EACA,eAAA;EACA,qBAAA;EACA,2BAAA;AADN;AAGI;EACI,WAAA;AADR","sourcesContent":[".Links {\n    display: flex;\n    align-items: center;\n  \n  ul {\n      list-style: none;\n      padding: 0;\n      display: flex; \n  }\n  \n  li {\n      margin: 0 10px;\n      padding: 10px;\n      text-decoration: none;\n  }\n  \n  li a {\n      padding: 15px;\n      color: black;\n      font-size: 24px;\n      text-decoration: none;\n      transition: color 0.3s ease;\n  \n    &:hover {\n        color: blue;\n    }\n  }\n\n    \n}\n  "],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
section p {
  ...
  color: #333;
  margin-bottom: 20px;
}`, "",{"version":3,"sources":["webpack://./src/components/Pexels/PexelsContent.module.scss"],"names":[],"mappings":"AAAA;EACE,aAAA;EACA,2BAAA;AACF;AAGE;EACE,WAAA;EACA,gBAAA;EACA,cAAA;EACA,cAAA;EACA,sBAAA;AADJ;AAKE;EACE,eAAA;EACA,cAAA;EACA,mBAAA;AAHJ;AAME;EACE,eAAA;EACA,WAAA;EACA,mBAAA;AAJJ","sourcesContent":["section {\n  padding: 20px;\n  margin: 50px 20px 20px 20px;\n \n  \n \n  video {\n    width: 100%;\n    max-width: 800px;\n    display: block;\n    margin: 0 auto;\n    border: 1px solid #ddd;\n  }\n\n\n  h1 {\n    font-size: 24px;\n    color: #000000;\n    margin-bottom: 10px;\n  }\n\n  p {\n    font-size: 16px;\n    color: #333;\n    margin-bottom: 20px;\n  }\n\n \n}\n\n\n\n\n\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
._QJ2kpxfVmZjZcz75z3H .YKipPXZr7X3I9e0nvRl9 {
  display: block;
  margin: -102px 10px 10px 1173px;
  color: black;
}
._QJ2kpxfVmZjZcz75z3H .MEn1ZNLyGj0QCkSMkgxY {
  display: block;
  margin: -49px 10px 10px 1382px;
  color: black;
}`, "",{"version":3,"sources":["webpack://./src/components/UserPortal/UserPortal.module.scss"],"names":[],"mappings":"AAAA;EACG,eAAA;AACH;AACG;EACC,cAAA;EACA,+BAAA;EACA,YAAA;AACJ;AAEG;EACC,cAAA;EACA,8BAAA;EACA,YAAA;AAAJ","sourcesContent":[".PortalContainer {\n   font-size: 20px;\n\n   .LSBtn {\n    display: block;\n    margin: -102px 10px 10px 1173px;\n    color: black;\n   }\n    \n   .CBtn {\n    display: block;\n    margin: -49px 10px 10px 1382px;\n    color: black;\n   }\n\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.OVqVPy7Fg0sY4TjW29kE .Ggg5mQq0C8Pt1dXdDYkU {
  font-size: 2.5rem;
  color: #333;
  margin-bottom: 20px;
  margin-top: 50rem;
...
.OVqVPy7Fg0sY4TjW29kE .lXVcQtMJkWrfFGLIyTcM {
  flex-basis: calc(50% - 5px);
}`, "",{"version":3,"sources":["webpack://./src/pages/HomeScreen/HomeScreen.module.scss"],"names":[],"mappings":"AAAA;EACE,aAAA;EACA,eAAA;EACA,uBAAA;EACA,YAAA;EACA,4HAAA;EACA,4BAAA;EACA,+BAAA;EACA,uBAAA;AACF;AACE;EACE,iBAAA;EACA,WAAA;EACA,mBAAA;EACA,iBAAA;EACA,WAAA;AACJ;AAEE;EACE,2BAAA;AAAJ","sourcesContent":[".home {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  padding: 0px;\n  background-image: url(https://cdn.dribbble.com/users/1937292/screenshots/7130478/media/b4ec823bfc0e4066ae20b422702b7487.gif);\n  background-repeat: no-repeat;\n  background-position: top center;\n  background-size: 100rem;\n\n  .style {\n    font-size: 2.5rem;\n    color: #333;\n    margin-bottom: 20px;\n    margin-top: 50rem;\n    width: 100%;\n  }\n\n  .pexels-content {\n    flex-basis: calc(50% - 5px);\n  }\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"home": `OVqVPy7Fg0sY4TjW29kE`,
	"style": `Ggg5mQq0C8Pt1dXdDYkU`,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_stripe_react-stripe-js_dist_react-stripe_umd_js-node_modules_stripe_stri-52ddff"], () => (__webpack_require__("./src/index.js")))

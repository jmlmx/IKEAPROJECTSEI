...
function FavoritesPage(_ref) {
  ...
  /* eslint-disable */
  console.log(...oo_oo("896e961b_0", favorites));
  /*--- Event Handlers --- */
  function handleSelectFavorite(favorite) {
    setActiveFavorites(favorite);
  }
  /*--- Rendered UI --- */
  return /*#__PURE__*/React.createElement("main", null, /*#__PURE__*/React.createElement("aside", null, "favorites"));
}

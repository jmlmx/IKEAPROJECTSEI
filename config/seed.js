...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'KASKER Disco Ball', emojiURL: 'https://i.imgur.com/D8Q1pSD.jpg', category: categories[0], price: 47.98, rating: 9/10},
    {name: 'MORABO Sofa', emojiURL: 'https://i.imgur.com/VJNA2ip.jpg',  category: categories[1], price: 1349.00, rating: 6/10},
    {name: 'LILLTRÄSK Lawn Chair', emojiURL: 'https://i.imgur.com/sWdKN15.jpg',  category: categories[1], price: 49.00, rating: 4/10},
    ...
    {name: 'MÖLLEKULLA Picture Frame', emojiURL: 'https://i.imgur.com/SQJhEXv.jpg', category: categories[2], price: 45.89, rating: 4/10},
    ...
    {name: 'ALMARÖD Washer & Dryer', emojiURL: 'https://i.imgur.com/1E4sTQc.jpg', category: categories[3], price: 1429.99, rating: 7/10},
    ...
    {name: 'KLAMPENBORG Kitchen Mat', emojiURL: 'https://i.imgur.com/XZdTMEN.jpg', category: categories[4], price: 25.99, rating: 6/10},
    ...
    {name: 'KRISTRUP Alarm Clock', emojiURL: 'https://i.imgur.com/K2OzkIZ.jpg', category: categories[5], price: 27.99, rating: 1/10},
